...
from .const import DOMAIN, CONF_URL, CONF_TOKEN, CONF_SHOW_DUE_IN, CONF_CREATE_UNIFIED_LIST, CONF_CREATE_ASSIGNEE_LISTS, CONF_USER_MAPPINGS
    ...
    async def async_update_todo_item(self, item: TodoItem, context = None) -> None:
        ...
        if item.status == TodoItemStatus.COMPLETED:
            try:
                ...
                res = await client.async_complete_task(item.uid.split("--")[0], completed_by)
